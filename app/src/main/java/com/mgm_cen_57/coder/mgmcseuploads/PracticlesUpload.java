...
public class PracticlesUpload extends AppCompatActivity {
    ...
    File f;
    String root,sub1,sub2,pos;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_practicles_upload);
        ...
        btnselectfile=findViewById(R.id.buttonselectfile_p);
        btnuploadfile=findViewById(R.id.buttonUpload_p);

        filestatus=findViewById(R.id.textViewFileselectionstatus_p);

        pd=new ProgressDialog(PracticlesUpload.this);
        ...
        btnselectfile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(ContextCompat.checkSelfPermission(PracticlesUpload.this, android.Manifest.permission.READ_EXTERNAL_STORAGE)== PackageManager.PERMISSION_GRANTED)
                {
                    selectPDF();
                }
                else
                {
                    ActivityCompat.requestPermissions(PracticlesUpload.this,new String[]{Manifest.permission.READ_EXTERNAL_STORAGE},9);
        ...
        btnuploadfile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(mUri!=null)
                    ...
                    Toast.makeText(PracticlesUpload.this, "Please select file", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void uploadfile(Uri uri) {
        ...
        mStorageRef.child(root).child(sub1).child(sub2).child(fullname).putFile(uri).
                addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        PracticleData ud=new PracticleData(downloadUrl,extension);
                        rf.child(root).child(sub1).child(sub2).child(onlyname).setValue(ud).addOnCompleteListener(new OnCompleteListener<Void>() {
                            @Override
                            public void onComplete(@NonNull Task<Void> task) {
                                if(task.isSuccessful())
                                {
                                    Toast.makeText(PracticlesUpload.this, "file uploaded", Toast.LENGTH_SHORT).show();
                                    pd.dismiss();
                                }
                                ...
                                {
                                    Toast.makeText(PracticlesUpload.this, "file not uploaded", Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
                    }
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(PracticlesUpload.this,e.toString(), Toast.LENGTH_SHORT).show();
